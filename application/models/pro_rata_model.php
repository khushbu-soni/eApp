<?php
class pro_rata_model extends CI_Model{
    //__construct
    public $data;
    ...
    function get(){
         ...
         $currency = $this->db->query("select * from prorata_master")->result();
    ...
    function get_by_id($id){
        // $data=array('id'=>$id);
         ...
         $currency = $this->db->query("select * from state where id=$id and is_deleted=0")->row_array();
         // $currency = $this->db->query("select * from category")->result_array();
        return $currency;
    }
