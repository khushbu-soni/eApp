              ...
              <div class="panel-body no-padding" style="display: block;">
               ...
               <table  class="table table-striped" id='example' class="display" cellspacing="0" width="100%">
                  ...
                  <tbody >
                    <?php
                     $i=1;
                     foreach ($deliver_orders  as $junk) {?>
                      
                    <tr>
                      <td><?php echo $i;?></td>
                      <td><?php echo $junk->orderID;?></td>
                      <td><?php echo $junk->customer_name;?></td>
                      <td><?php echo $junk->invoice_date?></td>
                      <td><?php echo $junk->grand_total;?></td>
                      <td><?php 
                      if($junk->payment_status==0)
                          echo "Unpaid";
                      if($junk->payment_status==1)
                          echo "Paid";
