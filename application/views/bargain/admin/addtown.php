           ...
           <div class="xs tabls">
            <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
              ...
              <div class="panel-body no-padding  " style="display: block;">
               <form role="form"  method="post"  enctype="multipart/form-data" action='<?php echo base_url()?>admin/town/create'>
                <div class='col-md-6'>
                  ...
                  <div class="form-group">
                    ...
                    <select id="dealtype" name="city_id" class="form-control">
                      <?php foreach ($cities as $junk) { ?>
                      <option value="<?php echo $junk->id;?>"><?php echo $junk->name?></option>
                      <?php }?>
                    </select>
                  </div>
