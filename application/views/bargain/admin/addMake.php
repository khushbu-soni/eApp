           ...
           <div class="xs tabls">
            <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
              ...
              <div class="panel-body no-padding  " style="display: block;">
               <form role="form"  method="post"  enctype="multipart/form-data" action='<?php echo base_url()?>admin/make/create'>
                <div class='col-md-6'>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="is_active" name="is_active" value="1" placeholder="Name" required>
                    </div>
                    
                  
           
                <div class="form-group">
                    <a href='<?php echo base_url();?>admin/make' class="btn btn-default" >Close</a>
