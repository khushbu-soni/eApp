...
<!--bootstrap-slider -->
<link href="<?php echo base_url();?>assets/website/css/bootshevtrap-slider.min.css" rel="stylesheet">
...
<section class="error_404 section-padding">
  <div class="container">
    <div class="row">
      ...
      <h6><li><a href="<?php echo base_url();?>productList/get?make=<?php echo $junk['id'];?>">Chevrolet <?php echo $junk['name']?></a></li></h6>
      <?php }?>
      </div>
      </div>
  </div>
