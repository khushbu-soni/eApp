    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li class ='active'><a  href="<?php echo base_url(); ?>battery_brands">Shop By Brands</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-2">
        ...
        <a href="<?php echo base_url();?>productList/get?brand_id=1"><img src="<?php echo base_url();?>assets/battries/brands/amron.jpg" class="img-responsive" alt="image"></a>
          <div class="background_icon"><i class="fa fa-road" aria-hidden="true"></i></div>
        </div>
      </div>
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
         <a href="<?php echo base_url();?>productList/get?brand_id=2">
         <img src="<?php echo base_url();?>assets/battries/brands/exide.jpg" class="img-responsive" alt="image"></a>
          <div class="background_icon"><i class="fa fa-road" aria-hidden="true"></i></div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
         <a href="<?php echo base_url();?>productList/get?brand_id=3">
        <img src="<?php echo base_url();?>assets/battries/brands/liveguard.jpg" class="img-responsive" alt="image">
        </a>
          <div class="background_icon"><i class="fa fa-road" aria-hidden="true"></i></div>
        </div>
      </div><div class="col-md-3 col-sm-2">
        <div class="error_text_m">
         <a href="<?php echo base_url();?>productList/get?brand_id=1">
        <img src="<?php echo base_url();?>assets/battries/brands/sonic.jpg" class="img-responsive" alt="image">
        </a>
          <div class="background_icon"><i class="fa fa-road" aria-hidden="true"></i></div>
        </div>
      </div>
