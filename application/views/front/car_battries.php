    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li class='' ><a href="<?php echo base_url(); ?>welcome" >Home</a>
            
          </li>
          <li><a href="<?php echo base_url()?>about">About Us</a></li>
          <li ><a  href="<?php echo base_url(); ?>battery_brands">Shop By Brands</a></li>
         
           <li class ='active'><a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop By Cars</a>
...
<section class="error_404 section-padding">
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-2">
        ...
        <a href="<?php echo base_url();?>car_battery/Audi">
          <h4 class="text-center">Audi</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/audi.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        ...
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/bmw">
          <h4 class="text-center">BMW</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/bmw.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/chevrolet">
          <h4 class="text-center">chevrolet</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/chevrolet.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/fiat">
          <h4 class="text-center">fiat</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/fiat.jpg" class="img-responsive" alt="image">
 ...
 <div class="row">
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/ford">
          <h4 class="text-center">Ford</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/ford.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        ...
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/honda">
          <h4 class="text-center">Honda</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/honda.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/hyundai">
          <h4 class="text-center">hyundai</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/hyundai.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <!-- <a href="<?php echo base_url();?>car_battery/mahindra"> -->
        <a href="#">
          <h4 class="text-center">mahindra</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/mahindra.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/MarutiSuzuki">
          <h4 class="text-center">maruti-suzuki</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/maruti-suzuki.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        ...
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/MercedesBenz">
          <h4 class="text-center">Mercedes</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/Mercedes.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <!-- <a href="<?php echo base_url();?>car_battery/mitsubishi"> -->
        <a href="#">
          <h4 class="text-center">mitsubishi</h4>
        </a>
           <!-- <img src="<?php echo base_url();?>assets/battries/car/mitsubishi.jpg" class="img-responsive" alt="image"> -->
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="#">
        <!-- <a href="<?php echo base_url();?>car_battery/nissan"> -->
          <h4 class="text-center">nissan</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/nissan.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/Renault">
          <h4 class="text-center">Renault</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/Renault.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        ...
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/skoda">
          <h4 class="text-center">skoda</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/skoda.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <!-- <a href="<?php echo base_url();?>car_battery/tata"> -->
        <a href="<?php echo base_url();?>car_battery/TataMotors">
          <h4 class="text-center">tata</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/tata.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/toyota">
          <h4 class="text-center">toyota</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/toyota.jpg" class="img-responsive" alt="image">
...
<div class="row">
      <div class="col-md-3 col-sm-2">
        <div class="error_text_m">
        <a href="<?php echo base_url();?>car_battery/volkswagen">
          <h4 class="text-center">volkswagen</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/volkswagen.jpg" class="img-responsive" alt="image">
      ...
      <div class="col-md-3 col-sm-2">
        ...
        <div class="error_text_m">
        <!-- <a href="<?php echo base_url();?>car_battery/volvo"> -->
        <a href="#">
          <h4 class="text-center">volvo</h4>
        </a>
           <img src="<?php echo base_url();?>assets/battries/car/volvo.jpg" class="img-responsive" alt="image">
