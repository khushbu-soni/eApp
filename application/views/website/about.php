...
<title>Battery Boss India's No.1 Online Store for Batteries & Inverters</title>
<!--Bootstrap -->
      ...
      <div class="col-md-6 col-sm-6">
        <div class="about_content row">
          <div class="col-md-5 col-sm-4 col-xs-4">
            <div class="about_img"> <img src="<?php echo base_url()?>assets/website/images/220x220.jpg" alt="image"> </div>
          </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="team_member">
          <div class="team_img"> <img src="<?php echo base_url()?>assets/website/images/700x450.jpg" alt="image">
