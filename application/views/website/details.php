...
<!--Bootstrap -->
<link rel="stylesheet" href="<?php echo base_url(); ?><?php echo base_url(); ?>assets/website/website/css/bootstrap.min.css" type="text/css">
<!--Custome Style -->
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo $items[0]->product_code?></h2>
        <div class="car-location"><span><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $items[0]->city?>,<?php echo $items[0]->state?></span></div>
        
      </div>

      <div class="col-md-3">
        <div class="price_info">
          <p style="text-decoration:line-through">Rs.<?php echo round($items[0]->mrp,2)?></p>
        </div>
      </div>
    </div>
    <div class="row well">
    ...
    <div class="col-md-12">
                ...
                <?php 
                $var=explode(',',$items[0]->key_features);
                 foreach( $var as $junk){?>
                <li><?php echo $junk?></li>
                <?php }?>
                </ul>
                ...
                <?php 
                $var=explode(',',$items[0]->key_benefits);
                 foreach( $var as $junk){?>
                <li><?php echo $junk?></li>
                <?php }?>
                </ul>
