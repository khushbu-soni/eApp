...
require_once APPPATH.'libraries/service/Google_Model.php';
require_once APPPATH.'libraries/service/Google_Service.php';
require_once APPPATH.'libraries/service/Google_ServiceResource.php';
require_once APPPATH.'libraries/auth/Google_AssertionCredentials.php';
require_once APPPATH.'libraries/auth/Google_Signer.php';
require_once APPPATH.'libraries/auth/Google_P12Signer.php';
require_once APPPATH.'libraries/service/Google_BatchRequest.php';
require_once APPPATH.'libraries/external/URITemplateParser.php';
require_once APPPATH.'libraries/auth/Google_Auth.php';
require_once APPPATH.'libraries/cache/Google_Cache.php';
require_once APPPATH.'libraries/io/Google_IO.php';
require_once APPPATH.'libraries/service/Google_MediaFileUpload.php';
