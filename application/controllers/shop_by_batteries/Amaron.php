...
class Amaron extends BaseController {
	...
	public function index()
	{
        ...
        $brand_id=$this->product_model->getBrandId('Amaron');
        $items=$this->product_model->getModel($brand_id[0]->id);
        // print_r($items);
        ...
        //
        // }
        $this->load->view('front/amron',$this->global);
